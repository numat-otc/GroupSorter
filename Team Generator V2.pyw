...
ToggleZoom = Button(WINDOW, text="☐", fg="black", width=3, height=1, font=(FONT1, 18), bg=(ButtonColour), border=(ButtonBorder), activebackground=(ButtonPressedColour), activeforeground=('black'), command=lambda: FullscreenToggle("event",FullScreenBool=FullScreenBool))
...
AddPlayer = Button(WINDOW, text="ADD", fg="green", width=8, height=1, font=(FONT1, 32), activeforeground=('dark green'), bg=(ButtonColour), border=(ButtonBorder), activebackground=(ButtonPressedColour), command=addtextname())
AddPlayer.place(relx=AddPlayerRelX, rely=0.9, anchor=CENTER)

SortPlayers = Button(WINDOW, text="SORT", fg=("RoyalBlue2"), width=8, height=1, font=(FONT1, 32), activeforeground=('RoyalBlue4'), bg=(ButtonColour), border=(ButtonBorder), activebackground=(ButtonPressedColour), command=addtextname())
